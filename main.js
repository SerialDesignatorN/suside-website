...
btn_download.onclick = function() {
    if (platform == "win") {
        window.location.href = "https://github.com/zeankundev/suside/releases/download/2.3.0/Suside_Editor_Installer_2.3.0_win.exe"
    }
    else if (platform == "linux") {
        window.location.href = "https://github.com/zeankundev/suside/releases/download/2.3.0/Suside.Editor_Installer_2.3.0_linux_x86_64.AppImage"
    }
